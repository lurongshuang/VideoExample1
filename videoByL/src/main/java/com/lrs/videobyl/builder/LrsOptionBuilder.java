package com.lrs.videobyl.builder;
...
public class LrsOptionBuilder extends GSYVideoOptionBuilder {
     ...
     */
    public LrsOptionBuilder setAutoFullWithSize(boolean autoFullWithSize) {
     ...
     */
    public LrsOptionBuilder setShowFullAnimation(boolean showFullAnimation) {
     ...
     * 设置循环
     */
    public LrsOptionBuilder setLooping(boolean looping) {
     ...
     */
    public LrsOptionBuilder setVideoAllCallBack(VideoAllCallBack mVideoAllCallBack) {
     ...
     * 是否开启自动旋转
     */
    public LrsOptionBuilder setRotateViewAuto(boolean rotateViewAuto) {
     ...
     */
    public LrsOptionBuilder setLockLand(boolean lockLand) {
     ...
     * 播放速度
     */
    public LrsOptionBuilder setSpeed(float speed) {
        this.mSpeed = speed;
        return this;
    }
     ...
     * 变声不变调
     */
    public LrsOptionBuilder setSoundTouch(boolean soundTouch) {
     ...
     * 全屏隐藏虚拟按键，默认打开
     */
    public LrsOptionBuilder setHideKey(boolean hideKey) {
     ...
     * 默认true
     */
    public LrsOptionBuilder setIsTouchWiget(boolean isTouchWiget) {
     ...
     * 默认 true
     */
    public LrsOptionBuilder setIsTouchWigetFull(boolean isTouchWigetFull) {
     ...
     * 是否需要显示流量提示,默认true
     */
    public LrsOptionBuilder setNeedShowWifiTip(boolean needShowWifiTip) {
     ...
     * 不设置使用默认
     */
    public LrsOptionBuilder setEnlargeImageRes(int mEnlargeImageRes) {
     ...
     * 不设置使用默认
     */
    public LrsOptionBuilder setShrinkImageRes(int mShrinkImageRes) {
     ...
     */
    public LrsOptionBuilder setShowPauseCover(boolean showPauseCover) {
     ...
     */
    public LrsOptionBuilder setSeekRatio(float seekRatio) {
        if (seekRatio < 0) {
            return this;
        }
     ...
     */
    public LrsOptionBuilder setRotateWithSystem(boolean rotateWithSystem) {
     ...
     */
    public LrsOptionBuilder setPlayTag(String playTag) {
     ...
     * 设置播放位置防止错位
     */
    public LrsOptionBuilder setPlayPosition(int playPosition) {
     ...
     */
    public LrsOptionBuilder setSeekOnStart(long seekOnStart) {
     ...
     * @param url
     */
    public LrsOptionBuilder setUrl(String url) {
        this.mUrl = url;
        return this;
    }
     ...
     * @param videoTitle
     */
    public LrsOptionBuilder setVideoTitle(String videoTitle) {
     ...
     * @param cacheWithPlay
     */
    public LrsOptionBuilder setCacheWithPlay(boolean cacheWithPlay) {
     ...
     */
    public LrsOptionBuilder setStartAfterPrepared(boolean startAfterPrepared) {
     ...
     */
    public LrsOptionBuilder setReleaseWhenLossAudio(boolean releaseWhenLossAudio) {
     ...
     * @param cachePath
     */
    public LrsOptionBuilder setCachePath(File cachePath) {
     ...
     * @param mapHeadData
     */
    public LrsOptionBuilder setMapHeadData(Map<String, String> mapHeadData) {
     ...
     * 进度回调
     */
    public LrsOptionBuilder setGSYVideoProgressListener(GSYVideoProgressListener videoProgressListener) {
     ...
     * 设置封面
     */
    public LrsOptionBuilder setThumbImageView(View view) {
     ...
     * 底部进度条-弹出的
     */
    public LrsOptionBuilder setBottomShowProgressBarDrawable(Drawable drawable, Drawable thumb) {
     ...
     * 底部进度条-非弹出
     */
    public LrsOptionBuilder setBottomProgressBarDrawable(Drawable drawable) {
     ...
     * 声音进度条
     */
    public LrsOptionBuilder setDialogVolumeProgressBar(Drawable drawable) {
     ...
     * 中间进度条
     */
    public LrsOptionBuilder setDialogProgressBar(Drawable drawable) {
     ...
     * 中间进度条字体颜色
     */
    public LrsOptionBuilder setDialogProgressColor(int highLightColor, int normalColor) {
     ...
     * 是否点击封面可以播放
     */
    public LrsOptionBuilder setThumbPlay(boolean thumbPlay) {
     ...
     */
    public LrsOptionBuilder setNeedLockFull(boolean needLoadFull) {
     ...
     * 锁屏点击
     */
    public LrsOptionBuilder setLockClickListener(LockClickListener lockClickListener) {
     ...
     */
    public LrsOptionBuilder setDismissControlTime(int dismissControlTime) {
     ...
     * 设置滤镜效果
     */
    public LrsOptionBuilder setEffectFilter(GSYVideoGLView.ShaderInterface effectFilter) {
     ...
     */
    public LrsOptionBuilder setOverrideExtension(String overrideExtension) {
     ...
     */
    @Deprecated
    public LrsOptionBuilder setSetUpLazy(boolean setUpLazy) {
        this.mSetUpLazy = setUpLazy;
        return this;
    }

    public LrsOptionBuilder setFullHideActionBar(boolean actionBar) {
        this.mActionBar = actionBar;
        return this;
    }

    public LrsOptionBuilder setFullHideStatusBar(boolean statusBar) {
        this.mStatusBar = statusBar;
        return this;
    }

    public void build(baseView gsyVideoPlayer) {
